  ...
  squares.forEach((element) => {
    ...
    element.addEventListener("drop", (e) => {
      ...
      if (turn === true && piece.classList[0] === "white") {
        if (
          (e.currentTarget.id && e.currentTarget.id === "square") ||
          (e.currentTarget.id && e.currentTarget.id === "piece")
        ) {
          const child = e.currentTarget.children[0];
          const source = findSquare(sourceSquare);
          if (
            source.children[0].className === "white" &&
            e.currentTarget.children.length === 1 &&
            e.currentTarget.children[0].className === "white"
          ) {
            ...
            if (piece.dataset.piece === "K1") {
              ...
              if (
                (moves.includes("e1,") ||
                  ...
                  moves.includes("h1,") ||
                  moves.includes("h1,")) &&
                source.dataset.square === "e1" &&
                destination.dataset.square === "g1"
              ) {
                whitewhiteKingSideCastle = false;
                return console.log(
                  "Invalid castle attempt, white king or rook4 has already moved"
                );
              }
              ...
              if (
                (moves.includes("e1,") ||
                  ...
                  moves.includes("a1,") ||
                  moves.includes(",a1")) &&
                king1.parentNode.dataset.square !== "e1"
              ) {
                whiteQueenSideCastle = false;
                return console.log(
                  "Invalid castle attempt, the white king or rook has already moved"
                );
              }
              ...
              if (
                sourceSquare === "e1" &&
                (f1.children.length === 1 || g1.children.length === 1) &&
                source.children[0].dataset.piece === "K1" &&
                piece.dataset.piece === "K1" &&
                destination.dataset.square === "g1"
              ) {
                return console.log("Invalid Castle Attempt");
              } else if (
                sourceSquare === "e1" &&
                f1.children.length === 0 &&
                g1.children.length === 0 &&
                source.children[0].dataset.piece === "K1" &&
                piece.dataset.piece === "K1" &&
                destination.dataset.square === "g1" &&
                whiteKingSideCastle
                ...
                (sourceSquare === "e1" &&
                  e.currentTarget.dataset.square === "c1" &&
                  (d1.children.length === 1 ||
                    c1.children.length === 1 ||
                    b1.children.length === 1)) ||
            ...
            if (piece.dataset.piece.includes("B")) {
              if (
                piece.parentNode.dataset.color !== e.currentTarget.dataset.color
              ) {
            ...
            if (
              piece.dataset.piece.includes("P") &&
              e.currentTarget.dataset.square.includes("8")
            ) {
              const img = new Image();
            ...
            piece.classList[0] === "white" &&
            child.classList[0] === "black"
          ) {
            if (
              piece.dataset.piece.includes("P") &&
              e.currentTarget.dataset.square.includes("8")
              ...
              const capturedPieceImage = createPieceImage(
          ...
          piece.classList[0] === "white" &&
          e.currentTarget.classList[0] === "black"
        ) {
          const capturedPieceImage = createPieceImage(
            e.currentTarget.children[0]
          );
          ...
          const tempParent = e.currentTarget.parentNode;
          sourceSquare && e.currentTarget.dataset.square
            ? moves.push(sourceSquare + "," + e.currentTarget.dataset.square)
            : console.log("Move not added");
      ...
      // *** Black Piece Logic Here ***
        ...
        if (
          (e.currentTarget.id && e.currentTarget.id === "square") ||
          e.currentTarget.children[0].classList[0] === "black" ||
          e.currentTarget.children[0].id === "piece"
        ) {
          const source = findSquare(sourceSquare);
          if (
            e.currentTarget.children.length === 1 &&
            source.children[0].className === "black" &&
            e.currentTarget.children[0].className === "black"
          ) {
            console.log("Can't take own piece!");
            return (turn = false);
            ...
            if (piece.dataset.piece === "K2") {
              ...
              if (
                (moves.includes("e8,") ||
                  ...
                  moves.includes("h8,") ||
                  moves.includes("h8,")) &&
                source.dataset.square === "e8" &&
                destination.dataset.square === "g8"
              ) {
              ...
              // king side castling
              if (
                ((sourceSquare === "e8" && f8.children.length === 1) ||
                  g8.children.length === 1) &&
                destination.dataset.square === "g8"
              ) {
                return console.log("Invalid Castle Attempt");
              } else if (
                sourceSquare === "e8" &&
                f8.children.length === 0 &&
                g8.children.length === 0 &&
                source.children[0].dataset.piece === "K2" &&
                piece.dataset.piece === "K2" &&
                destination.dataset.square === "g8" &&
                blackKingSideCastle
              ) {
                sourceSquare && e.currentTarget.dataset.square
              ...
              // queen side castling
                ...
                !blackQueenSideCastle &&
                (d8.children.length === 1 ||
                  d8.children[0].datasource.piece !== "K2" ||
                  (c8.children.length ||
                    c8.children[0].datasource.piece !== "K2") === 1 ||
                  b8.children.length === 1 ||
                  b8.children[0].datasource.piece !== "K2") &&
                sourceSquare === "e8" &&
                e.currentTarget.dataset.square === "c8"
              ) {
            ...
            if (
              piece.dataset.piece.includes("P") &&
              e.currentTarget.dataset.square.includes("1")
            ) {
              const img = new Image();
